...
class TestFeedbackPageClosingDate(WagtailPageTestCase):
    """
    ...
    def setUpTestData(cls):
        ...
        cls.email_field = cls.page.feedback_form_fields.create(
...
class TestFeedbackPageManualClose(WagtailPageTestCase):
    """
    Feedback has no natural deadline, so it also gets a manual on/off switch
    (form_open, FormPageManualCloseMixin) independent of the closing date -
    editors can stop accepting submissions immediately.
    """
